...
//
final public class HRP2LowLevelVisionProcessesSeqHelper
{
    public static void
    ...
    type()
    {
        if(typeCode_ == null)
        {
            ...
            typeCode_ = orb.create_alias_tc(id(), "HRP2LowLevelVisionProcessesSeq", orb.create_sequence_tc(0, orb.get_primitive_tc(org.omg.CORBA.TCKind.tk_string)));
        }
    ...
    id()
    {
        return "IDL:HRP2LowLevelVisionProcessesSeq:1.0";
    }
