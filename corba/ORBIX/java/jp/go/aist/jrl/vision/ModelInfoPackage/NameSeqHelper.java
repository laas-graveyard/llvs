...
//
final public class NameSeqHelper
{
    public static void
    ...
    type()
    {
        if(typeCode_ == null)
        {
            ...
            typeCode_ = orb.create_alias_tc(id(), "NameSeq", orb.create_sequence_tc(0, orb.get_primitive_tc(org.omg.CORBA.TCKind.tk_string)));
        }
    ...
    id()
    {
        return "IDL:ModelInfo/NameSeq:1.0";
    }
