...
// IDL:FSValue:1.0
//
final public class FSValueHelper
{
    public static void
    ...
    type()
    {
        if(typeCode_ == null)
        {
            ...
            typeCode_ = orb.create_alias_tc(id(), "FSValue", orb.create_sequence_tc(6, orb.get_primitive_tc(org.omg.CORBA.TCKind.tk_double)));
        }
